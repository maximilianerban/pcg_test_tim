...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FWorldRenderUpdated);
DECLARE_MULTICAST_DELEGATE(FWorldRenderUpdatedLambda);
...
public:
	...
	FWorldRenderUpdated WorldRenderUpdated;
	
	FWorldRenderUpdatedLambda WorldRenderUpdatedLambda;
