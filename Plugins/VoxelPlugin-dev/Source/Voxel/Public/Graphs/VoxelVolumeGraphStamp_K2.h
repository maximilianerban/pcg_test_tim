...
public:
	...
	static FVoxelVolumeGraphStampRef CastToVolumeGraphStamp(
	...
	static void MakeCopy(
		...
		FVoxelVolumeGraphStampRef& Copy)
	{
	 ...
	 * Increasing this will lead to more stamps being sampled per voxel, increasing generation cost
	 */
	UFUNCTION(BlueprintPure, Category = "Voxel|Stamp|Volume Graph", DisplayName = "Break Voxel Volume Graph Stamp", meta = (Keywords = "Break", AutoCreateRefTerm = "AdditionalLayers"))
	static void Break(
		const FVoxelVolumeGraphStampRef Stamp,
		UVoxelVolumeGraph*& Graph,
		UVoxelVolumeLayer*& Layer,
	...
	static void GetGraph(
		UPARAM(Required) FVoxelVolumeGraphStampRef Stamp,
		UVoxelVolumeGraph*& Graph)
	{
		Graph = FVoxelUtilities::MakeSafe<UVoxelVolumeGraph*>();
	...
	static void SetGraph(
		UPARAM(Required) FVoxelVolumeGraphStampRef Stamp,
		UPARAM(DisplayName = "Stamp") FVoxelVolumeGraphStampRef& OutStamp,
		UVoxelVolumeGraph* Graph)
	{
		OutStamp = Stamp;
