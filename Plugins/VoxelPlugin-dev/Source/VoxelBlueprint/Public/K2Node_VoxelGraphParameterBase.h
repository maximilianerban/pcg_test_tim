...
public:
	...
	virtual UEdGraphPin* GetParameterNamePin() const VOXEL_PURE_VIRTUAL({});
	virtual UClass* GetGraphClassType() const VOXEL_PURE_VIRTUAL({});
	virtual FName GetGraphPinName() const VOXEL_PURE_VIRTUAL({});
