...
public:
	...
	virtual bool IsNewPinNameValid(UEdGraphPin& Pin, FName NewName) const override;
	virtual void RenamePin(UEdGraphPin& Pin, FName NewName) override;
	virtual bool ShouldPromptRenameOnSpawn(const UEdGraphPin& Pin) const override;
...
private:
	FSharedVoidPtr OnNodeRecreateRequested;
